...
import MeshtasticController from '#controllers/meshtastic_controller'
...
router
  .group(() => {
    ...
    router.get('/meshtastic', [SettingsController, 'meshtastic'])
  })
  .prefix('/settings')
...
router
  .group(() => {
    router.post('/incoming', [MeshtasticController, 'handleIncoming'])
    router.get('/outgoing/:nodeId', [MeshtasticController, 'getOutgoing'])
    router.post('/outgoing/:id/sent', [MeshtasticController, 'markSent'])
    router.post('/outgoing/:id/sending', [MeshtasticController, 'markSending'])
    router.get('/status', [MeshtasticController, 'status'])
    router.get('/nodes', [MeshtasticController, 'listNodes'])
    router.patch('/nodes/:nodeId', [MeshtasticController, 'updateNode'])
    router.get('/messages', [MeshtasticController, 'listMessages'])
    router.get('/config', [MeshtasticController, 'getConfig'])
    router.patch('/config', [MeshtasticController, 'updateConfig'])
  })
  .prefix('/api/meshtastic')
